...
barplots_counts_spp_island <- ggplot(df, aes(x = spp, fill = nematode_count_categories)) +
  geom_bar(stat = "identity") +  # Use geom_bar for barplots
...
ggplot(df, aes(x = spp, y = count, fill = nematode_count_categories)) +
  geom_bar(stat = "identity") +
...
ggplot(df, aes(x = spp, y = nematode_count, fill = nematode_count_categories)) +
