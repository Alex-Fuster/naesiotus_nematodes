...
brightness_plot <- ggplot(brightness_data, 
  ...
  geom_jitter(color = "black", size = 0.5, alpha = 0.5, width = 0.2) +  # Raw data points in black
...
ggsave(here::here("output/figures/raw_data/raw_data_plot.png"), height = 12, width = 12)
```
